...
export default function SemesterExitSalePage() {
  ...
  const getOfferProbability = () => {
    if (discountPercent <= 10) return { status: 'Instant Acceptance ✅', color: 'text-emerald-400 bg-emerald-500/10 border-emerald-500/30' };
    if (discountPercent <= 20) return { status: 'High Chance of Approval ⚡', color: 'text-amber-400 bg-amber-500/10 border-amber-500/30' };
        ...
        {loading ? (
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[1, 2, 3].map((n) => (
                <div key={n} className="bg-card border border-border rounded-2xl p-5 h-32 animate-pulse space-y-3">
                  ...
                  <div className="h-6 bg-secondary rounded w-3/4 mt-2" />
                </div>
              ))}
            </div>
            <div className="h-6 w-56 bg-muted rounded animate-pulse pt-4" />
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[1, 2, 3].map((n) => (
                <div key={n} className="bg-card border border-border rounded-3xl p-6 h-96 animate-pulse space-y-4">
          ...
          <div className="flex flex-col items-center justify-center text-center p-12 bg-card border border-border rounded-3xl shadow-sm max-w-xl mx-auto space-y-6">
            ...
            <div className="space-y-2">
              <h3 className="text-xl font-bold text-foreground">No Senior Checkout Sales Yet</h3>
          ...
          <>
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between border-b border-border pb-3">
                <div>
                  <h3 className="font-extrabold text-xl tracking-tight flex items-center gap-2 text-foreground">
                    <Package className="w-5.5 h-5.5 text-amber-400" />
                ...
                <span className="text-[10px] font-bold text-amber-400 bg-amber-500/10 border border-amber-500/30 px-2 py-1 rounded-lg">BULK SAVINGS</span>
              </div>
                ...
                {bundles.map((bundle) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      {/* Bundled Items lists */}
                      <div className="mt-4 space-y-2 bg-secondary border border-border/80 p-3.5 rounded-2xl">
                        <p className="text-[10px] font-black uppercase tracking-wider text-muted-foreground">Included Room Assets:</p>
                    ...
                    <div className="pt-4 border-t border-border mt-6 flex items-center justify-between">
                      ...
                      <div className="flex gap-2">
                        <button 
                          ...
                          className="px-3 py-2 bg-card border border-border text-foreground hover:bg-secondary text-xs font-black rounded-xl transition cursor-pointer flex items-center gap-1 active:scale-95"
                        >
                        ...
                        <button 
                          ...
                          className="px-3.5 py-2 bg-primary text-primary-foreground text-xs font-black rounded-xl hover:opacity-90 active:scale-95 transition cursor-pointer shadow-sm"
                        >
                          Buyout
                        </button>
                      </div>
        ...
        {toastMessage && (
          <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50">
            <motion.div
              ...
              exit={{ y: 50, opacity: 0 }}
              className="bg-primary text-primary-foreground text-xs font-bold px-6 py-3.5 rounded-full shadow-2xl"
            >
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-extrabold text-base text-foreground">Fast Negotiation Terminal</h3>
                  <p className="text-[10px] text-muted-foreground font-semibold">Make instant buyouts off clearance prices</p>
                </div>
              </div>
              ...
              <div className="border-t border-b border-border py-4.5 space-y-4 text-xs font-bold">
                <div className="flex justify-between gap-3">
                  ...
                  <span className="text-foreground text-right truncate max-w-[200px]">{selectedBundle.title}</span>
                </div>
